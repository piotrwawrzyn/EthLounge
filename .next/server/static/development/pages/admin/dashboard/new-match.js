...
/* harmony import */ var _ApiMatchesListItem__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ApiMatchesListItem */ "./components/dashboard/new-match/ApiMatchesListItem.js");
  ...
  _createClass(ApiMatchesList, [{
            ...
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                debugedData = data.filter(function (match) {
                  ...
                  if (!match.league) return false; //  if (!match.serie) return false;
    ...
    value: function renderItems() {
      ...
      var markup = matches.map(function (match) {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_ApiMatchesListItem__WEBPACK_IMPORTED_MODULE_7__["default"], {
          key: match.pandaID,
          match: match
        });
      });
...
/***/ "./components/dashboard/new-match/ApiMatchesListItem.js":
/*!**************************************************************!*\
  !*** ./components/dashboard/new-match/ApiMatchesListItem.js ***!
  \**************************************************************/
/*! exports provided: default */
...
function (_Component) {
  ...
  function ApiMatchesItem(props) {
    ...
    _this.handleAdd = _this.handleClick.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.state = {
      modal: {
        open: false,
        data: {}
  ...
  _createClass(ApiMatchesItem, [{
    ...
    value: function renderModalBody(data) {
      ...
      var _loop = function _loop(i) {
        if (dataToSend["team_".concat(i, "_ID")] === null) {
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(data) {
        var dataToSend, teams, league, pandaID, startTime, serie, i, _api_response, _api_response2, api_response, match;

        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                dataToSend = data.dataToSend, teams = data.teams, league = data.league, pandaID = data.pandaID, startTime = data.startTime, serie = data.serie;
                i = 0;
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee3(match) {
        var pandaID, startTime, teams, league, serie, dataToSend, teamsInDb, i, _api_response3, team, api_response, leagueInDb, _api_response4, new_league, team_0_ID, team_1_ID, league_ID, _api_response5;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                pandaID = match.pandaID, startTime = match.startTime, teams = match.teams, league = match.league, serie = match.serie;
                dataToSend = {
                  team_0_ID: null,
                  team_1_ID: null,
                  league_ID: null
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_3__["Table"].Row, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_3__["Table"].Cell, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_3__["Header"], {
        ...
        as: "a",
        onClick: function onClick(e) {
          return _this3.handleClick(match);
        }
