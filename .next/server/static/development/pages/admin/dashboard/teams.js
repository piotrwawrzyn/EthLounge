...
function (_Component) {
  ...
  _createClass(TeamForm, [{
    ...
    value: function renderDropBox(logo, error) {
      ...
      var classNameModifier = error ? 'dropzone-div-error' : '';
...
function (_Component) {
  ...
  _createClass(TeamListItem, [{
    ...
    value: function render() {
      ...
      }, "".concat(this.displayName))), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_2__["Table"].Cell, null, this.renderImage(this.id, this.state.newLogo)), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_2__["Table"].Cell, null, this.renderIcons(this.state.editMode)));
    }
  }, {
    key: "renderImage",
    value: function renderImage(id, newLogo) {
      ...
      if (this.state.editMode) {
        if (this.state.newLogo) {
          return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_dropzone__WEBPACK_IMPORTED_MODULE_3___default.a, {
            style: {},
            accept: "image/png",
            onDrop: function onDrop(accepted, rejected) {
              return _this3.onDrop(accepted, rejected);
...
/* harmony import */ var _components_dashboard_shared_SearchableTable__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../components/dashboard/shared/SearchableTable */ "./components/dashboard/shared/SearchableTable.js");
/* harmony import */ var _components_dashboard_teams_TeamForm__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../components/dashboard/teams/TeamForm */ "./components/dashboard/teams/TeamForm.js");
/* harmony import */ var _components_dashboard_teams_TeamListItem__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../components/dashboard/teams/TeamListItem */ "./components/dashboard/teams/TeamListItem.js");
...
function (_Component) {
  ...
  _createClass(Teams, [{
    ...
    value: function render() {
      ...
      }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_dashboard_shared_SearchableTable__WEBPACK_IMPORTED_MODULE_6__["default"], {
        searchQuery: this.state.searchQuery,
        items: this.props.initial.teams,
        headers: ['ID', 'Name', 'Logo'],
        ItemComponent: _components_dashboard_teams_TeamListItem__WEBPACK_IMPORTED_MODULE_8__["default"],
        sortBy: 'displayName'
      })), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_3__["GridColumn"], {
        width: "6"
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_3__["Header"], {
        as: "h2"
      }, "Add New Team"), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_dashboard_teams_TeamForm__WEBPACK_IMPORTED_MODULE_7__["default"], null))));
    }
  }], [{
    key: "getInitialProps",
    value: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                req = props.req;
                _context.next = 3;
                return Object(_utils_CookieCall__WEBPACK_IMPORTED_MODULE_5__["default"])(req, '/api/teams');
