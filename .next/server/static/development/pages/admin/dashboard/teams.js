...
function (_Component) {
  ...
  _createClass(TeamForm, [{
    ...
    value: function renderDropBox(logo, error) {
      ...
      if (!lodash__WEBPACK_IMPORTED_MODULE_3___default.a.isEmpty(logo)) {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_2__["Label"], {
          size: "medium",
          image: true,
          className: "font-white dark-orange-bg"
        }, logo.name, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_2__["Icon"], {
          onClick: function onClick(e) {
            _this3.setState({
...
function (_Component) {
  ...
  function TeamListItem(props) {
    ...
    _this.state = {
      ...
      newLogo: '',
      newName: props.name,
      logoURL: "".concat(_config_config__WEBPACK_IMPORTED_MODULE_3__["backend"], "/img/teams/").concat(props.id, ".png")
    };
    return _this;
  }
  ...
  _createClass(TeamListItem, [{
    ...
    value: function render() {
      ...
      }, "".concat(name))), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_2__["Table"].Cell, null, this.renderImage(id, this.state.newLogo)), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_2__["Table"].Cell, null, this.renderIcons(this.state.editMode)));
    }
  }, {
    key: "renderImage",
...
/* harmony import */ var _components_dashboard_teams_TeamList__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../components/dashboard/teams/TeamList */ "./components/dashboard/teams/TeamList.js");
...
function (_Component) {
  ...
  _createClass(Teams, [{
    ...
    value: function render() {
      ...
      }), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_dashboard_teams_TeamList__WEBPACK_IMPORTED_MODULE_6__["default"], {
