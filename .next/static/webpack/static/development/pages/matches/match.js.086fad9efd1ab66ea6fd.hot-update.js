  ...
  _createClass(Match, [{
    ...
    value: function renderBetValue(tokensToBet) {
      var estimatedBetValue = tokensToBet.reduce(function (sum, token) {
        return sum + parseFloat(big_js__WEBPACK_IMPORTED_MODULE_19___default()(TokenFromWei(token)).mul(token.price.USD).toFixed(2));
      }, 0);
...
//# sourceMappingURL=match.js.086fad9efd1ab66ea6fd.hot-update.js.map