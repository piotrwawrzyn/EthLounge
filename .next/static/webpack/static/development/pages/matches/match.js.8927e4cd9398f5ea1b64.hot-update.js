...
function (_Component) {
  ...
  _createClass(BettingBox, [{
    ...
    value: function renderBetInfo(bet, odds) {
      var estimatedBetValue = " ".concat(bet.estimatedBetValue.toFixed(2), "$");
      var estimatedReturn = " ".concat((bet.estimatedBetValue * odds).toFixed(2), "$");
...
//# sourceMappingURL=match.js.8927e4cd9398f5ea1b64.hot-update.js.map