...
/* harmony import */ var _utils_TokenFromWei__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../utils/TokenFromWei */ "./utils/TokenFromWei.js");
  ...
  _createClass(Match, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_4__["Grid"], {
        ...
        floated: "right",
        className: "info-bet"
      }, this.renderBetValue(tokens.toBet), this.renderEstimatedReturn(betValue))), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("h2", null, user.bet ? 'Winnings' : 'Balances'), user.bet ? react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_match_WinningsBox__WEBPACK_IMPORTED_MODULE_18__["default"], {
        bet: user.bet
    ...
    key: "renderBetValue",
    value: function renderBetValue(tokensToBet) {
      var estimatedBetValue = tokensToBet.reduce(function (sum, token) {
        return sum + parseFloat(big_js__WEBPACK_IMPORTED_MODULE_19___default()(Object(_utils_TokenFromWei__WEBPACK_IMPORTED_MODULE_20__["default"])(token)).mul(token.price.USD).toFixed(2));
      }, 0);
      this.setState({
        estimatedBetValue: estimatedBetValue
      });
      if (tokensToBet.length > 0) return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_4__["List"].Item, null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_4__["Label"], {
        className: "orange-label-light",
        horizontal: true
      }, "ESTIMATED BET VALUE"), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("span", {
        className: "font-dark"
      }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("strong", null, " ".concat(estimatedBetValue.toFixed(2), "$"))));
      return '';
    }
  }, {
...
//# sourceMappingURL=match.js.67755fa52614a559587d.hot-update.js.map