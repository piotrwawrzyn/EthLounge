...
function (_Component) {
  ...
  _createClass(Match, [{
    ...
    value: function handleClick() {
      ...
      if (this.items.toBet.length === 0) errors.push('Please place at least one token in order to place a bet.');
      if (lodash__WEBPACK_IMPORTED_MODULE_13___default.a.isEmpty(this.pickedTeam)) errors.push('Please pick a team.');
...
//# sourceMappingURL=match.js.136905c733502f03c296.hot-update.js.map