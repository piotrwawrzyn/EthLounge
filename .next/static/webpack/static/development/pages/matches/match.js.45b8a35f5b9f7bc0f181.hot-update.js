...
function (_Component) {
  ...
  _createClass(BettingBox, [{
    ...
    value: function renderBetInfo(bet, odds) {
      var icon, status, className;
      bet.state = 'lost';

      switch (bet.state) {
        case 'pending':
          {
            className = 'bet-info-status-pending';
            icon = '';
            break;
          }
        ...
        case 'lost':
          {
            className = 'bet-info-status-lost';
            icon = 'minus';
            break;
          }
      }
...
//# sourceMappingURL=match.js.45b8a35f5b9f7bc0f181.hot-update.js.map