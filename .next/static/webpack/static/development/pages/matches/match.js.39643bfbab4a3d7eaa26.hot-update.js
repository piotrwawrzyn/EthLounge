...
/*#__PURE__*/
function (_Component) {
  _inherits(Winnings, _Component);

  function Winnings() {
    _classCallCheck(this, Winnings);

    return _possibleConstructorReturn(this, _getPrototypeOf(Winnings).apply(this, arguments));
  }
...
/* harmony default export */ __webpack_exports__["default"] = (Winnings);
...
/* harmony import */ var _components_match_Winnings__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../components/match/Winnings */ "./components/match/Winnings.js");
  ...
  _createClass(Match, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_4__["Grid"], {
        ...
        floated: "right",
        className: "info-bet"
      }, this.renderBetValue(betValue), this.renderEstimatedReward(betValue))), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("h2", null, user.bet ? 'Winnings' : 'Balances'), user.bet ? react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_match_BalanceBox__WEBPACK_IMPORTED_MODULE_10__["default"], {
        user: user,
        tokens: tokens.wallet
      }) : react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(WinningsBox, {
        bet: user.bet
      })));
    }
  }, {
...
//# sourceMappingURL=match.js.39643bfbab4a3d7eaa26.hot-update.js.map