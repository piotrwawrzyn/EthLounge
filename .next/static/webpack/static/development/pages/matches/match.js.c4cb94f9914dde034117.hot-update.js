  ...
  _createClass(TopMenu, [{
    ...
    value: function () {
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var _this$state, username, password, formData, response;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                console.log('Trying to log ' + username + ' : ' + password);
                formData = new FormData();
                formData.set('username', username);
                formData.set('password', password);
                _context.next = 7;
                return axios__WEBPACK_IMPORTED_MODULE_6___default.a.get('/login', {
                  data: '{"username":"lemme", "password":"lemme"}'
                });
...
//# sourceMappingURL=match.js.c4cb94f9914dde034117.hot-update.js.map