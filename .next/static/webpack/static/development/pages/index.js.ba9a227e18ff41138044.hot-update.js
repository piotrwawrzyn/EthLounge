...
function (_Component) {
  ...
  _createClass(EthLounge, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('http://ethlounge-api.herokuapp.com/api/current_gambler');
    ...
    value: function render() {
      ...
      }, "Click to debug "), this.state.debug.toString());
    }
  }]);
...
//# sourceMappingURL=index.js.ba9a227e18ff41138044.hot-update.js.map